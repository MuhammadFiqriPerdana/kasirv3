...
<!-- isinya -->
    <h1 class="h3 mb-0">
        Data Pengguna
        <button class="btn btn-primary btn-sm border-0 float-right" type="button" data-toggle="modal" data-target="#TambahProduk">Tambah Pengguna</button>
    </h1>
<hr>
...
<?php 
    $no = 1;
    $data_login = mysqli_query($conn,"SELECT * FROM `login` WHERE level !='1'");
