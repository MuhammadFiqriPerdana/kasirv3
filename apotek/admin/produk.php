...
if(isset($_POST['TambahProduk']))
{
    ...
    $InputProduk = mysqli_query($conn,"INSERT INTO produk (kode_produk,nama_produk,harga_modal,harga_jual,tgl_input, tgl_kadaluarsa, stok) values ('$kodeproduk','$namaproduk','$harga_modal','$harga_jual','$tanggal_input','$tanggal_kadaluarsa', '$stok')");
    if ($InputProduk){
